...
In `books`, you'll find my clippings from books I read on my ereader. All quotes have an header, which is linkable: if you want to cite a clipping, use the URL and add `#{ID}`. It's simple. 
